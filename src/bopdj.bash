...
if [[ "$TESTCASE" == "" ]]
then
  TESTCASE=taylor_green_vortex_512_512_256.lua
fi

cd $SOLEIL_PATH/src

$SOLEIL_PATH/src/bmc.bash $NUM_FRAGMENTS $NUM_TREE_LEVELS $SOLEIL_PATH/testcases/taylor_with_smaller_particles/$TESTCASE $MESH
